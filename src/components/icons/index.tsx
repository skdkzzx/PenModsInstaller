...
export function IconPackage({ className = 'w-5 h-5' }: { className?: string }) {
  return (
...
export function IconUsb({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <rect x="7" y="2" width="10" height="6" rx="1" />
      <line x1="12" y1="8" x2="12" y2="14" />
      <path d="M16 14H8a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1z" />
